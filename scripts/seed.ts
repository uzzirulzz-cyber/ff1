 ...
 * and populates sample products / orders / customers for demo data.
 *
...
async function main() {
  console.log('🌱 Seeding PlayBeat database...')
  ...
  const products = [
    {
      ...
      description: 'Digital PSN gift card redeemable on US PlayStation Store.',
      category: 'Gift Cards',
      price: 24000,
      stock: 100,
      status: 'active',
      digital: true,
      tags: ['psn', 'usa', 'giftcard'],
    },
    {
      sku: 'PSN-25-US',
      name: 'PlayStation Gift Card - $25 (USA)',
      description: 'Digital PSN gift card redeemable on US PlayStation Store.',
      category: 'Gift Cards',
      price: 14000,
      stock: 100,
    ...
    },
    {
      ...
      description: 'Netflix Premium account, 1 month subscription, 4K streaming.',
      category: 'Streaming',
      price: 6800,
      stock: 50,
      status: 'active',
    ...
    },
    {
      ...
      description: 'Spotify Premium individual plan, 3 months subscription.',
      category: 'Streaming',
      price: 4500,
      stock: 50,
      status: 'active',
    ...
    {
      sku: 'IPTV-12M',
      name: 'IPTV Subscription 12 Months',
      description: '12-month IPTV subscription with 10,000+ live channels and VOD.',
      category: 'IPTV',
      price: 8999,
      stock: 200,
      status: 'active',
    ...
    {
      sku: 'XBOX-50-US',
      name: 'Xbox Gift Card - $50 (USA)',
      description: 'Digital Xbox gift card for US Microsoft Store.',
      category: 'Gift Cards',
      price: 23000,
      stock: 75,
      status: 'active',
      digital: true,
      tags: ['xbox', 'usa', 'giftcard'],
    },
    {
      sku: 'STEAM-20-US',
      name: 'Steam Wallet - $20 (USA)',
      description: 'Steam wallet code redeemable on US Steam Store.',
      category: 'Gift Cards',
      price: 10500,
      stock: 80,
      status: 'active',
      digital: true,
      tags: ['steam', 'usa', 'giftcard'],
    },
    {
      sku: 'NP-12M',
      name: 'NordVPN 12 Months',
      description: 'NordVPN 12-month subscription, secure and private browsing.',
      category: 'VPN',
      price: 5200,
      stock: 60,
      status: 'active',
    ...
    {
      sku: 'DZN-1M',
      name: 'Disney+ 1 Month Premium',
      description: 'Disney+ Premium 1 month subscription, 4K UHD streaming.',
      category: 'Streaming',
      price: 3200,
      stock: 40,
      status: 'active',
    ...
    {
      sku: 'GP-50-US',
      name: 'Google Play Gift Card - $50 (USA)',
      description: 'Digital Google Play gift card redeemable on US Google Play Store.',
      category: 'Gift Cards',
      price: 23500,
      stock: 90,
      status: 'active',
      digital: true,
      tags: ['google', 'usa', 'giftcard'],
    },
    {
      sku: 'APP-25-US',
      name: 'Apple Gift Card - $25 (USA)',
      description: 'Apple gift card redeemable on US App Store, iTunes, Apple services.',
      category: 'Gift Cards',
      price: 13200,
      stock: 65,
      status: 'active',
      digital: true,
      tags: ['apple', 'usa', 'giftcard'],
    },
    {
      sku: 'AMZ-50-US',
      name: 'Amazon Gift Card - $50 (USA)',
      description: 'Amazon.com digital gift card for US store.',
      category: 'Gift Cards',
      price: 23800,
      stock: 70,
      status: 'active',
      digital: true,
      tags: ['amazon', 'usa', 'giftcard'],
    },
    {
      sku: 'CFG-1Y',
      name: 'ChatGPT Plus 1 Month',
      description: 'ChatGPT Plus 1 month subscription with priority access.',
      category: 'AI',
      price: 7800,
      stock: 30,
      status: 'active',
    ...
    },
    {
      ...
      description: 'Discord Nitro 12-month subscription with server boosts.',
      category: 'Streaming',
      price: 19500,
      stock: 35,
      status: 'active',
    ...
    {
      sku: 'CRN-12M',
      name: 'Crunchyroll Mega 12 Months',
      description: 'Crunchyroll Mega Fan 12-month subscription, ad-free anime.',
      category: 'Streaming',
      price: 8200,
      stock: 28,
      status: 'active',
    ...
    },
    {
      ...
      description: 'YouTube Premium 3-month subscription, ad-free + background play.',
      category: 'Streaming',
      price: 4200,
      stock: 55,
      status: 'active',
    ...
    },
    {
      ...
      description: 'Adobe Creative Cloud All Apps 12-month subscription.',
      category: 'Software',
      price: 89000,
      stock: 10,
      status: 'active',

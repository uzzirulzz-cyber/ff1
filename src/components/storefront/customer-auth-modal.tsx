...
export function CustomerAuthModal({ open, onOpenChange, onAuthed }: CustomerAuthModalProps) {
  const [mode, setMode] = useState<'login' | 'signup'>('login')
  const [form, setForm] = useState({ email: '', password: '', name: '', confirmPassword: '', agreeToTerms: false })
